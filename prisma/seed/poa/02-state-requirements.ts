...
export async function seedStateRequirements() {
  console.log('  🗺️  Seeding state requirements...');

  const existingCount = await prisma.stateRequirements.count();
  if (existingCount > 0) {
    console.log('  ⏭️  State requirements already seeded, skipping...');
    return;
  }
  ...
  const states = [
    ...
    createStateReq({
      ...
      hasStatutoryForm: true,
      statutoryFormCitation: 'N.C. Gen. Stat. §32C-1-105',
    ...
    createStateReq({
      ...
      hasStatutoryForm: true,
      statutoryFormRequired: false,
      statutoryFormCitation: 'Tenn. Code Ann. §34-6-101 et seq.',
    ...
    createStateReq({ state: 'AR', stateName: 'Arkansas', witnessesRequired: true, numberOfWitnesses: 2, agentCannotBeWitness: true, witnessRestrictions: 'Agent cannot serve as witness', hasStatutoryForm: true, statutoryFormCitation: '§28-68-104' }),
    createStateReq({ state: 'CO', stateName: 'Colorado', hasStatutoryForm: true, statutoryFormCitation: '§15-14-705' }),
    createStateReq({ state: 'CT', stateName: 'Connecticut', witnessesRequired: true, numberOfWitnesses: 2, agentCannotBeWitness: true, witnessRestrictions: 'Agent cannot serve as witness', hasStatutoryForm: true, statutoryFormCitation: '§1-350b', strictnessLevel: 'strict' }),
    ...
    createStateReq({ state: 'DC', stateName: 'District of Columbia', hasStatutoryForm: true, statutoryFormCitation: '§21-2081' }),
    createStateReq({ state: 'HI', stateName: 'Hawaii', hasStatutoryForm: true, statutoryFormCitation: '§551D-2.5' }),
    ...
    createStateReq({ state: 'IA', stateName: 'Iowa', hasStatutoryForm: true, statutoryFormCitation: '§633B.201' }),
    createStateReq({ state: 'KS', stateName: 'Kansas', hasStatutoryForm: true, statutoryFormCitation: '§58-652' }),
    ...
    createStateReq({ state: 'ME', stateName: 'Maine', hasStatutoryForm: true, statutoryFormCitation: '18-C §5-501' }),
    ...
    createStateReq({ state: 'MA', stateName: 'Massachusetts', hasStatutoryForm: true, statutoryFormCitation: 'Ch. 190B §5-501' }),
    ...
    createStateReq({ state: 'MN', stateName: 'Minnesota', hasStatutoryForm: true, statutoryFormCitation: '§523.23' }),
    ...
    createStateReq({ state: 'MO', stateName: 'Missouri', hasStatutoryForm: true, statutoryFormCitation: '§404.710' }),
    createStateReq({ state: 'MT', stateName: 'Montana', hasStatutoryForm: true, statutoryFormCitation: '§72-31-305' }),
    createStateReq({ state: 'NE', stateName: 'Nebraska', hasStatutoryForm: true, statutoryFormCitation: '§30-4033' }),
    ...
    createStateReq({ state: 'NJ', stateName: 'New Jersey', hasStatutoryForm: true, statutoryFormCitation: '§46:2B-9' }),
    createStateReq({ state: 'NM', stateName: 'New Mexico', hasStatutoryForm: true, statutoryFormCitation: '§45-5B-104' }),
    createStateReq({ state: 'ND', stateName: 'North Dakota', hasStatutoryForm: true, statutoryFormCitation: '§30.1-30-05' }),
    ...
    createStateReq({ state: 'OR', stateName: 'Oregon', hasStatutoryForm: true, statutoryFormCitation: '§127.005' }),
    ...
    createStateReq({ state: 'SC', stateName: 'South Carolina', witnessesRequired: true, numberOfWitnesses: 2, agentCannotBeWitness: true, witnessRestrictions: 'Agent cannot serve as witness', hasStatutoryForm: true, statutoryFormCitation: '§62-8-201' }),
    createStateReq({ state: 'SD', stateName: 'South Dakota', hasStatutoryForm: true, statutoryFormCitation: '§59-7-2.5' }),
    createStateReq({ state: 'UT', stateName: 'Utah', hasStatutoryForm: true, statutoryFormCitation: '§75-9-101' }),
    createStateReq({ state: 'VT', stateName: 'Vermont', hasStatutoryForm: true, statutoryFormCitation: '14 V.S.A. §3501' }),
    ...
    createStateReq({ state: 'WV', stateName: 'West Virginia', witnessesRequired: true, numberOfWitnesses: 2, agentCannotBeWitness: true, witnessRestrictions: 'Agent cannot serve as witness', hasStatutoryForm: true, statutoryFormCitation: '§39B-1-4' }),
    createStateReq({ state: 'WI', stateName: 'Wisconsin', hasStatutoryForm: true, statutoryFormCitation: '§243.10' }),
    createStateReq({ state: 'WY', stateName: 'Wyoming', hasStatutoryForm: true, statutoryFormCitation: '§3-5-101' }),
  ];

  await prisma.stateRequirements.createMany({ data: states });

  console.log('  ✅ Created requirements for all 51 states (12 with detailed data)');
}
